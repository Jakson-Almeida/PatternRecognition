...
\begin{frame}{Matrizes de confusão $10\times 10$}
  \begin{center}
    \includegraphics[width=0.92\linewidth]{cm_agg_all_classifiers_pct.png}
  \end{center}
\end{frame}
...
\begin{frame}{Conclusões}
  \begin{itemize}
    ...
    \item Classes raras e AdaBoost fraco são limitações claras.
